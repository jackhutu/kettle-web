SchedulerPanel = Ext.extend(Ext.Panel, {
	layout: 'border',
	defaults: {border: false},
	initComponent: function() {
		var items = Ext.apply(this.items, {region: 'center'});
		delete this.items;
		...
		SchedulerPanel.superclass.initComponent.call(this);
	}
...
SchedulerDialog = Ext.extend(Ext.Window, {
	...
	initComponent: function() {
		...
		this.initData = function(node) {
			Ext.Ajax.request({
				url: GetUrl('schedule/load.do'),
				method: 'POST',
				params: {name: node.attributes.objectId},
